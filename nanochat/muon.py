...
class DistMuon(torch.optim.Optimizer):
    ...
    Uses batched stacking + single fused kernel + vectorized dist ops (reduce_scatter_tensor /
    all_gather_into_tensor) instead of per-parameter loops for better performance.
    """
