#!/bin/bash
# Setup script for TPU v5e (v5litepod) with verified compatible packages
# Based on: https://cloud.google.com/tpu/docs/v5e-training
# and: https://github.com/pytorch/xla/releases
#
# Usage: gcloud compute tpus tpu-vm ssh nanochat-tpu --zone=us-west4-a --command="bash -s" < scripts/tpu/setup_v5e.sh
#
# v5e uses the same PyTorch/XLA packages as v6e - the runtime version
# (v2-alpha-tpuv5-lite) handles the hardware differences.

set -e

echo "============================================"
echo "TPU v5e Setup - Verified Package Versions"
echo "============================================"
...
# Install verified compatible packages for v5e
...
# was tested but is NOT supported by libtpu 0.0.21
ENVEOF
